...
def cot():
    '''Will be used to find out cot(x)'''
    num = float(input("Enter angle in Radians "))
    res = math.cot(num)
    global result
...
def arcsec():
    '''Will be used to find out arcsec(x)'''
    num = float(input("Enter number: "))
    res = math.asec(num)
    global result
    result = " arcsec of" + str(num) + " = " + str(res)
    print(res)
 
def arccosec():
    '''Will be used to find out arccosec(x)'''
    num = float(input("Enter number: "))
    res = math.acosec(num)
    global result
    result = " arccosec of" + str(num) + " = " + str(res)
    print(res)
 
def arccot():
    '''Will be used to find out arccot(x)'''
    num = float(input("Enter number: "))
    res = math.acot(num)
    global result
    result = " arccot of" + str(num) + " = " + str(res)
    print(res)
...
while True:
    ...
    if operation == "addition" or operation == '1':  #it can match from index from menu or the name which is insensitive of case
        ...
        if trigo == "sin" or trigo == 'i' :
            ...
            arctan()
        elif trigo == 'arccosec' or trigo == 'x' :
            arccosec()
        elif trigo == 'arcsec' or trigo == 'xi' :
            arcsec()
        elif trigo == 'arccot' or trigo == 'xii' :
            arccot()
        else :
